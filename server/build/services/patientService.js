...
var buildUrlEmail = function buildUrlEmail(doctorID, token) {
  return "".concat(process.env.URL_REACT, "/verify-booking?token=").concat(token, "&doctorID=").concat(doctorID);
};
var postBookAppointment = function postBookAppointment(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var doctorId, timeType, date, existingConfirmed, _yield$db$User$findOr, _yield$db$User$findOr2, user, existingPending, token, newBooking, userUpdate;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            if (!(!data.fullName || !data.phoneNumber || !data.email || !data.address || !data.reason || !data.date || !data.gender)) {
              _context.next = 3;
              break;
            }
          ...
          case 8:
            existingConfirmed = _context.sent;
          ...
          case 13:
            ...
            _yield$db$User$findOr2 = _slicedToArray(_yield$db$User$findOr, 1);
          ...
          case 37:
            ...
            console.error('sendEmail failed: ', _context.t0);
          case 40:
            return _context.abrupt("return", resolve({
              errCode: 0,
...
var postVerifyBookAppointment = function postVerifyBookAppointment(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var appointment, existingConfirmed;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 10:
            existingConfirmed = _context2.sent;
