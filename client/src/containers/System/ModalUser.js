...
class ModalUser extends Component {
    ...
    render() {
        return (
        <Modal className='modal-lg' isOpen= {this.props.isOpenModal} toggle={() => {this.toggle()}} >
            ...
            <div className='container'>
               <div className='row  py-2'>
                    <div className='col-6'>
                        <label>Email:</label>
                        <input id = 'email' type='text' className='form-control' value={this.state.email} onChange={this.handleInputUser}/>
                    </div>
                    <div className='col-6'>
                        <label>Password:</label>
                        <input id = 'password' type='password' className='form-control' value={this.state.password} onChange={this.handleInputUser}  />
                    </div>
               </div>
               <div className='row py-2'>
                    <div className='col-6'>
            ...
            <ModalFooter>
            <Button className='px-3' color="primary" onClick={() => {this.handleCreateUser(this.state)}}>
                Add user
            </Button>{' '}
